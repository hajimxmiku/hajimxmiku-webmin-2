...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/nginx.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/iptables.up.rules"
...
# User Status
cd
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/status
chmod +x status
...
cd
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/Autokick-debian.sh
bash Autokick-debian.sh

# Install Menu for OpenVPN
cd
wget https://raw.githubusercontent.com/hajimxmiku/hajimxmiku-webmin-2/master/menu
...
# info
clear
echo -e "\e[32m auto script by: Hajimxmiku"
echo -e "\e[35m Download config (.ovpn) anda di: $MYIP:81/client.tar"
echo "OpenSSH  : 22, 143"
echo "Dropbear : 109, 110, 443"
echo "SQUID   : $MYIP:8080 / $MYIP:60000 "
echo -e "\e[34m Untuk Menggunakan Menu taip/run commad (menu)"
echo ""
echo "----------"
...
echo ""
echo -e "\e[31m YOUR VPS WILL AUTOMATICALLY REBOOT"
echo ""
echo "==============================================="
# REBOOT VPS
reboot
